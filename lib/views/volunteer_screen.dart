...
class VolunteerScreen extends StatelessWidget {
            ...
            children: [
                  ...
                  return Padding(
                    ...
                    child: Container(
                      ...
                      child: DropdownButton<Ngo>(
                        ...
                        hint: Text("Select a NGO     ", style: GoogleFonts.poppins(color: Colors.white,fontSize: 18)),
                        icon: const Icon(Icons.holiday_village_outlined, color: Colors.white),
                        borderRadius: BorderRadius.circular(8),
                        value: provider.selectedNgo,
                        onChanged: (ngo) {
                          Provider.of<VolunteerProvider>(context, listen: false)
                              .updateSelectedNgo(ngo!);
                        },
                        items: provider.ngoList.map<DropdownMenuItem<Ngo>>((Ngo ngo) {
                  ...
                  return Padding(
                    ...
                    child: Container(
                      ...
                      child: DropdownButton<String>(
                        dropdownColor: const Color.fromARGB(255, 90, 89, 89),
                        style: GoogleFonts.poppins(color: Colors.white),
                        hint: Text("Select a Date       ", style: GoogleFonts.poppins(color: Colors.white, fontSize: 18)),
                        ...
                        items: provider.dateSlots.map<DropdownMenuItem<String>>((date) {
                  ...
                  return Padding(
                    ...
                    child: Container(
                      ...
                      child: DropdownButton<String>(
                        dropdownColor: const Color.fromARGB(255, 90, 89, 89),
                        style: GoogleFonts.poppins(color: Colors.white),
                        hint: Text("Select Time Slot ", style: GoogleFonts.poppins(color: Colors.white,fontSize: 18)),
                        ...
                        items: provider.timeSlots.map<DropdownMenuItem<String>>((timeSlot) {
                          return DropdownMenuItem<String>(
                            value: timeSlot,
                            child: Text(timeSlot),
                          );
              ...
              Padding(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () => handleConfirmation(context), // Pass context for provider access
  ...
  void handleConfirmation(BuildContext context) {
    // Implement logic to confirm selection, send notification to NGO (if applicable)
    // Update volunteer schedule using Provider.of<VolunteerProvider>(context). (access data and methods)
